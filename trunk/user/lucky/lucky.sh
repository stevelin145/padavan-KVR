...
lucky_dl() {
	...
	lk_url=`nvram get lucky_url`
 	if [ "$lucky_daji" = "1" ] ; then
 		[ -z "$lk_url" ] && lk_url1="http://release.ilucky.net/${tag}/${new_tag}_wanji/lucky_${new_tag}_Linux_mipsle_softfloat_wanji.tar.gz"
   		lk_url2="http://release.66666.host/${tag}/${new_tag}_wanji/lucky_${new_tag}_Linux_mipsle_softfloat_wanji.tar.gz"
   	else
    		[ -z "$lk_url" ] && lk_url1="http://release.ilucky.net/release/${tag}/${new_tag}_lucky/lucky_${new_tag}_Linux_mipsle_softfloat.tar.gz"
